...
deepspeed "${DEEPSPEED_ARGS[@]}" \
	--module safe_rlhf.algorithms.simpo \
	--train_datasets ultrafeedback-pref/train \
	--eval_datasets ultrafeedback-pref/test \
