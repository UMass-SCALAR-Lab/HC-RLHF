...
from safe_rlhf.algorithms.dpo_pop_fixed_ema.trainer import DPO_PoP_Fixed_EMA_Trainer
...
def main() -> None:
    ...
    trainer = DPO_PoP_Fixed_EMA_Trainer(args, ds_train_config, ds_eval_config)
    # For Train purposes
    trainer.train()
    trainer.save()
