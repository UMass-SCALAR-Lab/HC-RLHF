...
class DPO_PoP_Fixed_EMA_Trainer(SupervisedTrainerEMA):
    TRAINING_TYPE = 'dpo-pop-fixed-ema'
    ...
    def loss(
        ...
        **kwargs
        ...
        for i in range(batch_size):
            ...
            loss_ = -F.logsigmoid(self.scale_coeff * ((pref_chosen_log_ratio-pref_rejected_log_ratio)-torch.clamp((unpref_chosen_log_ratio-unpref_rejected_log_ratio),min=self.args.margin_min,max=self.args.margin_max)))
            losses.append(loss_)
