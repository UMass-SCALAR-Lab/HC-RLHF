...
from safe_rlhf.algorithms.simpo_pop_fixed_ema.trainer import SimPO_PoP_Fixed_EMA_Trainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    training_parser.add_argument(
        ...
        type=float,
        default=0.0,
        help='The excess threshold for the pop constraint.',
    )
    training_parser.add_argument(
        '--margin_min',
        type=float,
        default=0.0,
        help='The Minimum value for the Margin',
    )
    training_parser.add_argument(
        '--margin_max',
        type=float,
        default=10.0,
        help='The Maximum value for the Margin',
    )
    training_parser.add_argument(
        '--tau',
        type=float,
        default=0.99,
        help='The EMA coefficient',
    )
    training_parser.add_argument(
        '--lambda_init',
        type=float,
...
def main() -> None:
    ...
    trainer = SimPO_PoP_Fixed_EMA_Trainer(args, ds_train_config, ds_eval_config)
    # For Train purposes
    trainer.train()
    trainer.save()
